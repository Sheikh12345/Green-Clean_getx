              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    Divider(thickness: 2,),
                    SizedBox(height: height*0.01,),
                    const AutoSizeText("Please select your prefered pricing option",style: TextStyle(color: Colors.grey,fontWeight: FontWeight.w500,fontSize: 16),),
                    SizedBox(height: height*0.02,),
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Center(child: AutoSizeText("\$60.00/Total",style: TextStyle(color: Colors.white),presetFontSizes: [20,18],),),
                      ),
                    ),
                    SizedBox(height: height*0.02,),
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Center(child: AutoSizeText("\$20.00/Hour",style: TextStyle(color: Colors.white),presetFontSizes: [20,18],),),
                      ),
                    ),
                    SizedBox(height: height*0.02,),
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Center(child: AutoSizeText("Make Offer",style: TextStyle(color: Colors.white),presetFontSizes: [20,18],),),
                      ),
                    ),
